        ...
        const DishWithId = ({match}) => {
            return (
                <DishDetail
                    ...
                    comments={this.props.comments.comments.filter((comment) => comment && comment.dishId === parseInt(match.params.id, 10))}
                ...
                <TransitionGroup>
                    <CSSTransition key={this.props.location.key} classNames="page" timeout={300}>
                        <Switch>
                            ...
                            <Route path={"/confusion/menu/:id"} component={DishWithId}/>
                            <Route path={"/confusion/contactus"}
                                   component={() =>
                            ...
                            />
                            <Route path={"/confusion/aboutus"} component={() => <About leaders={this.props.leaders}/>}/>
